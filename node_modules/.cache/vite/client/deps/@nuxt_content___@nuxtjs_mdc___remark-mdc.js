...
function callVisitor(key2, node, visitor, path) {
  ...
  if (isMap(node))
    return (_a = visitor.Map) == null ? void 0 : _a.call(visitor, key2, node, path);
  if (isSeq(node))
    return (_b = visitor.Seq) == null ? void 0 : _b.call(visitor, key2, node, path);
  if (isPair(node))
    return (_c = visitor.Pair) == null ? void 0 : _c.call(visitor, key2, node, path);
  if (isScalar(node))
    return (_d = visitor.Scalar) == null ? void 0 : _d.call(visitor, key2, node, path);
  if (isAlias(node))
    return (_e = visitor.Alias) == null ? void 0 : _e.call(visitor, key2, node, path);
  return void 0;
}
...
var isMergeKey = (ctx, key2) => (merge.identify(key2) || isScalar(key2) && (!key2.type || key2.type === Scalar.PLAIN) && merge.identify(key2.value)) && (ctx == null ? void 0 : ctx.doc.schema.tags.some((tag) => tag.tag === merge.tag && tag.default));
...
var toMarkdown = (opts = {}) => {
  const applyAutomaticUnwrap = (node, { safeTypes = [] }) => {
    ...
    if (!((_a = node.mdc) == null ? void 0 : _a.unwrapped)) {
      return;
    }
    node.children = [
      {
  ...
  const frontmatter = (node) => {
    ...
    const attrs = entries.sort(([key1], [key2]) => key1.localeCompare(key2)).reduce((acc, [key2, value2]) => {
      if ((key2 == null ? void 0 : key2.startsWith(":")) && isValidJSON(value2)) {
        try {
    ...
    return "\n" + ((opts == null ? void 0 : opts.yamlCodeBlockProps) ? stringifyCodeBlockProps(attrs).trim() : stringifyFrontMatter(attrs).trim());
  };
...
${content(node, context)}`.trim();
  ...
  function containerComponent(node, _, context) {
    ...
    if ((value + attributesText).length > ((opts == null ? void 0 : opts.maxAttributesLength) || 80) || Object.keys(node.fmAttributes).length > 0 || // remove: allow using both yaml and inline attributes simentensoly
    ((_a = node.children) == null ? void 0 : _a.some((child) => child.type === "componentContainerSection"))) {
...
var fromMarkdown = (opts = {}) => {
  ...
  const applyYamlCodeBlockProps = (node) => {
    ...
    if (firstSection && ((_a = firstSection.children) == null ? void 0 : _a.length) && firstSection.children[0].type === "code" && firstSection.children[0].lang === "yaml" && firstSection.children[0].meta === "[props]") {
  ...
  const applyAutomaticUnwrap = (node, { safeTypes = [] }) => {
    ...
    node.children.splice(childIndex, 1, ...(child == null ? void 0 : child.children) || []);
    node.mdc = node.mdc || {};
...
var remarkMDC = function remarkMDC2(opts = {}) {
  ...
  if (opts.autoUnwrap === void 0 && ((_a = opts.experimental) == null ? void 0 : _a.autoUnwrap)) {
    opts.autoUnwrap = opts.experimental.autoUnwrap ? { safeTypes: [] } : false;
  }
  if (opts.yamlCodeBlockProps === void 0 && ((_b = opts.experimental) == null ? void 0 : _b.componentCodeBlockYamlProps)) {
  ...
  if ((_c = opts == null ? void 0 : opts.components) == null ? void 0 : _c.length) {
